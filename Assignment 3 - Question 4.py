...
def answer_four():
    ...
    q1 = task1_df
    q1['avgGDP'] = q1.mean(axis=1)
    q3_df = q1
    q3_df.sort_values(by='avgGDP', ascending=False, inplace=True)
    
    #returning GDP difference for the UK (6th country)
    
    return q3_df.iloc[5][2015] - q3_df.iloc[5][2006]
