...
def answer_seven():
    ...
    #Creating citation ratio column
    q1['Citations ratio'] = q1['Self-citations'] / q1['Citations']
    
    return (q1[q1['Citations ratio'] == q1['Citations ratio'].max()].index[0], q1[q1['Citations ratio'] == q1['Citations ratio'].max()].iloc[0]['Citations ratio'])
